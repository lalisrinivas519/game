                  ...
                  <div class="w-6/12 basis-6/12 xl:w-6/12 xl:basis-6/12 lg:w-6/12 lg:basis-6/12 md:w-full md:basis-full sm:w-full sm:basis-full xsm:w-full xsm:basis-full relative px-[15px]">
                     <div class="login-page__wrap">
                        ...
                        <div style="text-align: center; margin-bottom: 20px;">
                           <h5 class="login-page__wrap__title" style="margin-bottom: 20px;">Register Here!</h5>
                           <br>
                           <form class="login-page__form" method="POST" action="register_process.php" style="display: flex; flex-direction: column; align-items: center; width: 100%; max-width: 290px; margin: 0 auto;">
							  ...
							  <div class="form-group mb-4" style="width: 100%;">
                                 <input type="text" name="name" placeholder="Enter Name" style="width: 100%; padding: 10px; border-radius: 25px; border: 1px solid #ccc; box-sizing: border-box;" required>
                              </div>
							  <div class="form-group mb-4" style="width: 100%;">
                                 <input type="email" name="email" placeholder="Enter Email Address" style="width: 100%; padding: 10px; border-radius: 25px; border: 1px solid #ccc; box-sizing: border-box;" required>
                              </div>
							  <div class="form-group mb-4" style="width: 100%;">
                                 <input type="number" name="mobile" placeholder="Enter Phone Number" style="width: 100%; padding: 10px; border-radius: 25px; border: 1px solid #ccc; box-sizing: border-box;" required>
                              </div>
                              <div class="form-group mb-4" style="width: 100%;">
                              ...
                              <div style="text-align: center; margin-top: 16px; width: 100%;">
                                 <p class="mb-0" style="margin: 0;">Already Have an Account? <a class="link style1" href="login.php" style="color: #45f882; text-decoration: none;">Login</a></p>
                              </div>
                           </form>
                        </div>
                     </div>
